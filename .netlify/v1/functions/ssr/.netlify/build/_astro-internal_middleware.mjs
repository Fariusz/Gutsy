...
import 'kleur/colors';
import { o as originPathnameSymbol, A as AstroError, F as ForbiddenRewrite } from './chunks/astro/server_CYzSJK5e.mjs';
import 'clsx';
import 'cookie';
import 'html-escaper';
...
const onRequest$1 = defineMiddleware(async (context, next) => {
  const supabase = createServerClient("https://leykisozvcsolnnzlxsq.supabase.co", undefined                                   , {
    cookies: {
      get(key) {
